...
class ModelERExog():
    ...
    def UpdateVariables(self):
        ...
        self.parameters = [self.td ,self.tva1 ,self.tva2 ,self.tva3 ,self.tva4 ,self.tva5 ,self.tvar ,self.tvab ,self.tz1 ,self.tz2 ,self.tz3 ,self.tz4 ,self.tz5 ,self.tzr ,self.tzb ,
            ...
            self.A1 ,self.A2 ,self.A3 ,self.A4 ,self.A5 ,self.Ar ,self.Ab ,self.alphaxr ,self.alphaco ,
            self.Axco ,self.alphaxb ,self.alphang ,self.Axng ,self.a11 ,self.a21 ,self.a31 ,self.a41 ,self.a51 ,self.ar1 ,self.ab1 ,self.a12 ,
...
class MainScreen(tkinter.Tk):
    ...
    def __init__(self):
        ...
        EndoVarButton = self.GenerateButton(ResultsFrame, self.imageList[4], "ENDOGENOUS VARIABLES", ("arial 10 bold"), None, 10,110)

        self.GraphicsFrame = self.GenerateFrame(self, 1345,475,"DETAILED RESULTS", ("Times 12 bold"), 5, 240)
        self.ToolbarFrame = self.GenerateFrame(self, 1345,50,None, ("Times 12 bold"), 5, 715)
    ...
    def ShowParameters(self):
        ...
        if self.ButtonName == "Model Parameters(BY)":
            ...
            ParametersNames = list(self.m_cfrun.parameters_str.keys())
            ParametersInfo = list(self.m_cfrun.parameters_str.values())
    ...
    def FlowchartsScreen(self):
        ...
        self.aggicultureButton = self.GenerateButton(sectorFrame, imageList[0], "Agriculture", ("Calibri 12 bold"), self.flow_diagram, 10, 10)
        self.servicesButton = self.GenerateButton(sectorFrame, imageList[1], "Service and Trade", ("Calibri 12 bold"), self.flow_diagram, 10, 50)
        self.transportationButton = self.GenerateButton(sectorFrame, imageList[2], "Transportation", ("Calibri 12 bold"), self.flow_diagram, 10, 90)
        self.constructionButton = self.GenerateButton(sectorFrame, imageList[3], "Construction", ("Calibri 12 bold"), self.flow_diagram, 10, 130)
        self.industryButton = self.GenerateButton(sectorFrame, imageList[4], "Industry", ("Calibri 12 bold"), self.flow_diagram, 10, 170)
        self.rafineryButton = self.GenerateButton(sectorFrame, imageList[5], "Rafinery", ("Calibri 12 bold"), None, 10, 210)
        self.botasButton = self.GenerateButton(sectorFrame, imageList[6], "BOTAS", ("Calibri 12 bold"), None, 10, 250)
