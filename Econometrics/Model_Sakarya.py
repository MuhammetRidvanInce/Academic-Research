...
raw_data = pd.read_csv("https://raw.githubusercontent.com/MutadisMutandis/datas2/main/Sakarya.csv").dropna()
raw_data
...
# Anlamsız oldukları için Sabit, X4, X5 ve X8 modelden çıkarıldı.
